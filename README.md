# [DEPRECATED] Marketo Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_marketo`](https://github.com/fivetran/dbt_marketo) instead, which now contains all models previously found here._
